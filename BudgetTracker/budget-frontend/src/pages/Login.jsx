...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ✅ Pass full user data including id from response
          ...
          <div style={formCard}>
            ...
            <form onSubmit={handleSubmit} style={form} autoComplete="off">
              ...
              <div style={{ position: "relative" }}>
                ...
                />
                <div onClick={() => setShowPassword(!showPassword)} style={eyeIcon}>
                  {showPassword ? "👁️" : "👁️‍🗨️"}
                </div>
              </div>
...
const forgotLink = { color: "#667eea", textDecoration: "none", fontWeight: 600 };
const footerText = { textAlign: "center", marginTop: 20, color: "#64748b" };
const signupLink = { color: "#667eea", fontWeight: 700, textDecoration: "none" };