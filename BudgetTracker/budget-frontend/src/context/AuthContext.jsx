...
//     let storedId = null;
//     if (storedUser) {
//       try { storedId = JSON.parse(storedUser)?.id; } catch(e) {}
//     }
//
//     return {
//       ...data,
//       id: data.id || data.userId || data.subject || data._id || storedId
//     };
//   }, []);
//
...
//
//       // ✅ If server didn't return an ID, keep the one from localStorage
//       if (!validatedUser.id) {
//         const storedUser = localStorage.getItem("user");
//         if (storedUser) {
//           try { validatedUser.id = JSON.parse(storedUser)?.id; } catch(e) {}
//         }
//       }
//
